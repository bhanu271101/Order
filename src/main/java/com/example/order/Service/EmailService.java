...
public void sendOrderConfirmationMail(String toEmail, String customerName,
                                      List<ProductDTO> products, AddressEntity addressEntity) throws MessagingException {
    StringBuilder productListHtml = new StringBuilder("<ul>");
    for (ProductDTO product : products) {
        productListHtml.append("<li>")
                       .append(product.getMobileName())
    ...
    html.append("<h4>Products:</h4>");
    html.append(productListHtml.toString());
